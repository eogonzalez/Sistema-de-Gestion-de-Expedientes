<%@ Page Title="Tipos de Usuarios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoUsuarios.aspx.cs" Inherits="Sistema_de_Gestion_Expedientes.Administracion.TipoUsuarios" %>
                        ...
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <asp:Button ID="btnModificar" runat="server"
                                    ...
                                    Text="Modificar" CssClass="btn btn-success" />

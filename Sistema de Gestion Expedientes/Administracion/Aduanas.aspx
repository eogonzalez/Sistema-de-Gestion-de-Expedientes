<%@ Page Title="Aduanas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Aduanas.aspx.cs" Inherits="Sistema_de_Gestion_Expedientes.Administracion.Aduanas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="panel-body form-vertical">
            ...
            <br />
            <div>
                <asp:GridView runat="server" ID="gvAduanas"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="nombre" HeaderText="Aduana" />
        ...
        <asp:Panel runat="server" ID="pnl_nuevo" CssClass="panel panel-primary" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label AssociatedControlID="txtNombre" CssClass="control-label col-xs-2" runat="server" Text="Aduana: "></asp:Label>
                    <div class="col-xs-10">
